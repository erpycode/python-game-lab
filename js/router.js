...
PB.router = (() => {
    ...
    function handle() {
        ...
        if (handler) {
            // سشن رو فقط وقتی ریست کن که فصل عوض شده باشه یا از مسیر فصل خارج بشیم؛
            // حرکت بین آموزش/تمرین/چالش/نتیجه همون فصل باید سشن رو حفظ کنه تا پیشرفت از بین نره
            ...
            if (!sameChapter) PB.engine?.resetSession();
