...
PB.catalog = (() => {
    const chapters = [
        ...
        { id: 18, title: "توابع لامبدا", subtitle: "توابع یک‌خطی", level: "expert", color: "#a855f7", emoji: "⚡", estMinutes: 14, goals: ["lambda", "map/filter", "sorted با کلید"] },
        { id: 19, title: "لیست کامپریهنشن", subtitle: "لیست‌سازی خلاقانه", level: "expert", color: "#a855f7", emoji: "🧬", estMinutes: 14, goals: ["[x for x]", "فیلتر if", "متداخلی"] },
